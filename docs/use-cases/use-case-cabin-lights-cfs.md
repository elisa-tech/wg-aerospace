...
- Monitoring App (CoPilot based)
  - Continuously monitors correct functionality (e.g. stay witihn time limits)
...
- Options/Scenarios to consider and enhance on
  ...
  - "Three/More Devices": Switch and Cabin light arte connected on 2 devices, Monitoring App hosted on another one, all connected through a network
