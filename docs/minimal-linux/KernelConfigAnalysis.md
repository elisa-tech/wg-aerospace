...
described. Our DWARF numbers are therefore directly comparable in *kind* to
#139's published elf-to-sloc figures.
...
versions; to track *our* baseline going forward, use the progression table in
