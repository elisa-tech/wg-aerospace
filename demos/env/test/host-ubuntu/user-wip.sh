...
# TBD need to fix security group to allow http or https for apt.
# Just https doesn't work
...
su -c "cd /home/ubuntu/wg-aerospace && git checkout mlw/docker-install-check-first" ubuntu
