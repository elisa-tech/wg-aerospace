...
_ResetCountersCmd(void) {
  /*
   * Test Case For:
   * void {{app_name_uc}}_ResetCounters( const {{app_name_uc}}_ResetCounters_t
   * *Msg )
   */
  {
    {
...
_ProcessCmd(void) {
  ...
  _ProcessCmd_t TestMsg;
  {
    {
      app_name_uc
    }
  }
  _ExampleTable_t TestTblData;
...
_DisplayParamCmd(void) {
  /*
   * Test Case For:
   * void  {{app_name_uc}}_DisplayParamCmd( const
   * {{app_name_uc}}_DisplayParamCmd_t *Msg )
   */
  {
    {
      app_name_uc
