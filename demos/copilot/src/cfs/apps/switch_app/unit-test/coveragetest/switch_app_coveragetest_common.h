 ...
 * @file
 *
 * Common definitions for all switch_app coverage tests
 */

#ifndef SWITCH_APP_COVERAGETEST_COMMON_H
#define SWITCH_APP_COVERAGETEST_COMMON_H
...
#endif /* SWITCH_APP_COVERAGETEST_COMMON_H */
