...
CFE_Status_t SWITCH_APP_SendHkCmd(const SWITCH_APP_SendHkCmd_t *Msg) {
  ...
  */
  SWITCH_APP_Data.HkTlm.Payload.CommandErrorCounter =
...
CFE_Status_t SWITCH_APP_NoopCmd(const SWITCH_APP_NoopCmd_t *Msg) {
  ...
  CFE_EVS_SendEvent(SWITCH_APP_NOOP_INF_EID, CFE_EVS_EventType_INFORMATION,
                    "SAMPLE: NOOP command %s", SWITCH_APP_VERSION);
...
SWITCH_APP_ResetCountersCmd(const SWITCH_APP_ResetCountersCmd_t *Msg) {
  ...
  CFE_EVS_SendEvent(SWITCH_APP_RESET_INF_EID, CFE_EVS_EventType_INFORMATION,
