...
#include "switch_app_eds_dispatcher.h"

/*
 * Define a lookup table for SAMPLE app command codes
 */
static const EdsDispatchTable_SWITCH_APP_Application_CFE_SB_Telecommand_t
    SAMPLE_TC_DISPATCH_TABLE = {
        .CMD = {.NoopCmd_indication = SWITCH_APP_NoopCmd,
                ...
                .DisplayParamCmd_indication = SWITCH_APP_DisplayParamCmd},
        .SEND_HK = {.indication = SWITCH_APP_SendHkCmd}};
...
void SWITCH_APP_TaskPipe(const CFE_SB_Buffer_t *SBBufPtr) {
  ...
  Status = EdsDispatch_SWITCH_APP_Application_Telecommand(
