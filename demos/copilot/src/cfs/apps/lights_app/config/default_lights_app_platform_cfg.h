 ...
 * @file
 *
 * LIGHTS_APP Application Platform Configuration Header File
 *
 ...
 */
#ifndef LIGHTS_APP_PLATFORM_CFG_H
#define LIGHTS_APP_PLATFORM_CFG_H

#include "lights_app_internal_cfg.h"
