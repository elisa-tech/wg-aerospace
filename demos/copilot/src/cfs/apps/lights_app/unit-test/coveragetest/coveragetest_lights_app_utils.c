...
void Test_LIGHTS_APP_TblValidationFunc(void)
{
    /*
     * Test Case For:
    ...
    UtAssert_INT32_EQ(LIGHTS_APP_TblValidationFunc(&TestTblData), CFE_SUCCESS);

    /* error case should return LIGHTS_APP_TABLE_OUT_OF_RANGE_ERR_CODE */
    TestTblData.Int1 = 1 + LIGHTS_APP_TBL_ELEMENT_1_MAX;
    UtAssert_INT32_EQ(LIGHTS_APP_TblValidationFunc(&TestTblData), LIGHTS_APP_TABLE_OUT_OF_RANGE_ERR_CODE);
}

void Test_LIGHTS_APP_GetCrc(void)
{
    /*
     * Test Case For:
...
{
    ADD_TEST(LIGHTS_APP_TblValidationFunc);
    ADD_TEST(LIGHTS_APP_GetCrc);
}
